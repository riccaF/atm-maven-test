...
import com.example.Database.BankDatabase;
import com.example.GUI.CashDispenser;
import com.example.GUI.Keypad;
...
public class Withdrawal extends Transaction
{
   ...
   public void execute()
   {
      ...
      do
      {
         ...
         if ( amount.getValore()!=0) // it correspods to Cancel
         {

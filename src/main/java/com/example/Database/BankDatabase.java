...
import com.example.BusinessLogic.Account;
...
public class BankDatabase
{
   ...
   public BankDatabase()
   {
      ...
      accounts[ 0 ] = new Account( 12345, 54321, new Euro(1000), new Euro(1200) );
      accounts[ 1 ] = new Account( 98765, 56789, new Euro(200), new Euro(200) );  
